...
const CheckData = () => {
  ...
  const toPayment = async () => {
    const isValid = await clientForm
      .validateForm()
  ...
  return (
    <form onSubmit={clientForm.handleSubmit}>
      <FormArea>
        ...
        <InputArea>
          ...
          <input
            ...
            id="Recipient"
            name="Recipient"
            value={clientForm.values.Recipient}
            onChange={clientForm.handleChange}
            onBlur={clientForm.handleBlur}
          />
          <small>
            {getErrorMessage('Recipient', clientForm.errors.Recipient)}
          </small>
        </InputArea>
        <InputArea>
        ...
        <DoubleInputArea>
          <HalfForm>
            ...
            />
            <small>
              {getErrorMessage('PostalCode', clientForm.errors.PostalCode)}
            </small>
          </HalfForm>
          <HalfForm>
            ...
            <input
              ...
              id="Number"
              name="Number"
              value={clientForm.values.Number}
              onChange={clientForm.handleChange}
              onBlur={clientForm.handleBlur}
            />
        ...
        <InputArea>
          ...
          <input
            ...
            id="Complement"
            name="Complement"
            value={clientForm.values.Complement}
            onChange={clientForm.handleChange}
            onBlur={clientForm.handleBlur}
          />
          <small>
            {getErrorMessage('Complement', clientForm.errors.Complement)}
          </small>
        </InputArea>
      </FormArea>
      <BtnArea>
        <FormBtn
          formLevel="Continuar com o pagamento"
          onClick={toPayment}
          type="button"
        />
      </BtnArea>
      <BtnArea>
        <FormBtn
          formLevel="Voltar para o carrinho"
          onClick={toCart}
          type="button"
        />
      </BtnArea>
