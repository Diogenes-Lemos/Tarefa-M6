...
const Checkout = () => {
  const clientSucess = useSelector(
    (state: RootState) => state.checkout.client.sucess
  )
  const paymentSucess = useSelector(
    (state: RootState) => state.checkout.payment.sucess
  )
  const orderSucess = useSelector(
    (state: RootState) => state.checkout.order.sucess
  )
